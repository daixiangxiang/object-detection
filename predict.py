...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    video_path      = 'E:/FFOutput/road/Set01.mp4'
    video_save_path = ""
    video_fps       = 25.0
    ...
    if mode == "predict":
        ...
        while True:
            ...
            img = "E:\\data\\工厂\\th\\yx_img_1332.jpg"
            try:
                ...
                r_image.show()
                r_image.save("E:\\QQ\\response\\gc\\21332'.jpg")
    ...
    #批量检测
    # frcnn = FRCNN()
    # road = ("176x99.jpg", "320x180.jpg", "640x360.jpg", "1024x576.jpg", \
    #         "1920x1080.jpg",)
    # #img = "E:/FFOutput/road/320x180.jpg"
    # # 创建工作簿
    # # 创建一个workbook 设置编码
    ...
    #     image = Image.open("E:/FFOutput/road/"+road[i])
    #     worksheet.write(i, 0, road[i])
    #     content, r_image = frcnn.detect_image(image)
    #     for j in range(len(content)):
    #         worksheet.write(i, j + 1, content[j])
    #     r_image.show()
    #     r_image.save("C:\\Users\\23687\\Pictures\\Saved Pictures\\{}.jpg".format(road[i]))
    # workbook.save('E:/FFOutput/road/pred2.xls')
    ...
    #             r_image = frcnn.detect_image(image)
    #             r_image.show()
    #             r_image.save("C:\\Users\\23687\\Pictures\\Saved Pictures\\1451.jpg")